...
//    }
    ...
    private void addExhibition(Integer id, String title, LocalDate start, int gallery_id, String theme) {
        Exhibition e = new Exhibition (id, title, start, theme,gallery_id);
        e.setTheme(theme);
    }
