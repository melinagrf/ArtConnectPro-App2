...
public class DiscoverController {
    ...
    public void initialize() {
        // Charger les expositions directement depuis la BDD
    ...
    private void addExhibitionCard(Exhibition e) {
        ...
        String galleryInfo = e.getGallery() != 0 ? "Galerie #" + e.getGallery() : "Unknown";

        card.getChildren().addAll(
                new Label("FEATURED EXHIBITION"),
                new Label(e.getEntitled() != null ? e.getEntitled() : "—") {{
                    setStyle("-fx-font-weight: bold;");
                }},
                new Label("Theme: " + (e.getTheme() != null ? e.getTheme() : "—")),
                new Label("Gallery: " + galleryInfo)
        );
